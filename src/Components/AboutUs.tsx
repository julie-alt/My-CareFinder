    ...
    <Box>
      ...
      >
        ...
        <Text fontSize="lg">
          ...
          and up-to-date information on hospitals, clinics, and other healthcare
          facilities in their area. Our platform is designed to be user-friendly
          and accessible, ensuring that everyone can find the care they need
          quickly and easily.
        </Text>
      </Box>
    </Box>
